...
@section('page-script')
  <script type="module">
    $(function() {
      var dataTableAdmissionTypes = $('#eligibility-criteria-table'),
        dt_admissionTypes;
      // Users List datatable
      if (dataTableAdmissionTypes.length) {
        dt_admissionTypes = dataTableAdmissionTypes.DataTable({
          ajax: "{{ route('settings.admissions.eligibility-criteria') }}",
          columns: [{
              data: ''
            },
            {
            ...
            },
            {
              ...
              render: function(data, type, full, meta) {
                ...
                for (var i = 0; i < $assignedTo.length; i++) {
                  $output += '<span class="badge bg-label-primary m-1">' + $assignedTo[i]['short_name'] + ' (' + $assignedTo[i]['vertical_name'] + ')' +
                    '</span></a>';
                }
            ...
            },
            {
              ...
              render: function(data, type, full, meta) {
                ...
                return '<label class="switch">\
                                    <input onclick="updateActiveStatus(&#39;/settings/admissions/eligibility-criteria/status/' + full['id'] + '&#39;, &#39;eligibility-criteria-table&#39;)" type="checkbox" ' +
          ...
          buttons: [{
            text: 'Add Eligibility Criterion',
            className: 'add-new btn btn-primary mb-3 mb-md-0 waves-effect waves-light',
            attr: {
              'onclick': "add('{{ route('settings.admissions.eligibility-criteria.create') }}', 'modal-md')"
            },
...
@section('content')
  <h4 class="mb-4">Eligibility Criteria</h4>
  <div class="card">
    <div class="card-datatable table-responsive">
      <table id="eligibility-criteria-table" class="table border-top">
        <thead>
          <tr>
            <th></th>
            <th>Name</th>
