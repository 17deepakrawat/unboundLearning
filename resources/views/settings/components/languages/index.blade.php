  ...
  <script type="module">
    $(function() {
      var table = $('#languages-table').DataTable({
        ajax: "{{ route('settings.components.languages') }}",
        columns: [{
            data: ''
          },
          {
          ...
          },
          {
            ...
            render: function(data, type, full, meta) {
              ...
              return '<label class="switch">\
                      <input onclick="updateActiveStatus(&#39;/settings/components/languages/status/' + full['id'] + '&#39;, &#39;languages-table&#39;)" type="checkbox" ' +
        ...
        buttons: [{
          ...
          attr: {
            'onclick': "add('{{ route('settings.components.languages.create') }}', 'modal-md')"
          },
...
@section('content')
  ...
  <div class="card">
    <div class="card-datatable table-responsive">
      <table id="languages-table" class="table border-top">
        <thead>
          <tr>
            <th></th>
            <th>Name</th>
