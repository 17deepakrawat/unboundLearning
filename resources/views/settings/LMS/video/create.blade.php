<div class="modal-header">
  ...
  <form id="addVideoForm" action="{{ route('settings.lms.videos') }}" method="POST">
    <div class="modal-body">
      <div class="row g-3">
        ...
        <div class="col-md-4">
          ...
          <input type="text" id="name" name="name" class="form-control" placeholder="ex: My Lecture Video" autofocus />
        </div>
        <div class="col-md-4">
