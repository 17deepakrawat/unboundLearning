...
@section('title', 'Settings | Sub-Sources')
                ...
                dt_admissionTypes = dataTableAdmissionTypes.DataTable({
                    ...
                    columnDefs: [{
                        ...
                        },
                        {
                            ...
                            orderable: false,
                            render: function(data, type, full, meta) {
                                return '<span class="text-nowrap"><span class="badge bg-label-primary m-1">' +
                                    full.source.name +
                                    ' </span></span> ';
                            }
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                ...
                                return '<label class="switch">\
                                                                                                      <input onclick="updateActiveStatus(&#39;/settings/leads/sub-sources/status/' +
                                    full[
                                        'id'] +
                                    '&#39;, &#39;sub-sources-table&#39;)" type="checkbox" ' +
                                    $checkedStatus +
                                    ' class="switch-input">\
                    ...
                    buttons: [{
                        ...
                        attr: {
                            'onclick': "add('{{ route('settings.leads.sub-sources.create') }}', 'modal-md')"
                        },
...
@section('content')
    <h4 class="mb-4">Sub-Sources</h4>
    <div class="card">
        <div class="card-datatable table-responsive">
            <table id="sub-sources-table" class="table border-top">
                <thead>
                    <tr>
                        <th></th>
                        <th>Name</th>
