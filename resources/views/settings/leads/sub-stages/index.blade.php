...
@section('title', 'Settings | Sub-Stages')
      ...
      if (dataTableAdmissionTypes.length) {
        dt_admissionTypes = dataTableAdmissionTypes.DataTable({
            ...
            },
            {
              ...
              render: function(data, type, full, meta) {
                ...
                return '<label class="switch">\
                                                                                                                                  <input onclick="updateActiveStatus(&#39;/settings/leads/sub-stages/status/' +
                  full[
                    'id'] +
                  '&#39;, &#39;sub-stages-table&#39;)" type="checkbox" ' +
                  $checkedStatus +
                  ' class="switch-input">\
          ...
          buttons: [{
            ...
            attr: {
              'onclick': "add('{{ route('settings.leads.sub-stages.create') }}', 'modal-md')"
            },
...
@section('content')
  <h4 class="mb-4">Sub-Stages</h4>
  <div class="card">
    <div class="card-datatable table-responsive">
      <table id="sub-stages-table" class="table border-top">
        <thead>
          <tr>
            <th></th>
            <th>Name</th>
