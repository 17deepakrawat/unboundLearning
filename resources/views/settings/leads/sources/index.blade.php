...
@section('title', 'Settings | Sources')
            ...
            if (dataTableAdmissionTypes.length) {
                dt_admissionTypes = dataTableAdmissionTypes.DataTable({
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                ...
                                return '<label class="switch">\
                                                              <input onclick="updateActiveStatus(&#39;/settings/leads/sources/status/' +
                                    full[
                                        'id'] +
                                    '&#39;, &#39;sources-table&#39;)" type="checkbox" ' +
                    ...
                    buttons: [{
                        ...
                        attr: {
                            'onclick': "add('{{ route('settings.leads.sources.create') }}', 'modal-md')"
                        },
...
@section('content')
    <h4 class="mb-4">Sources</h4>
    <div class="card">
        <div class="card-datatable table-responsive">
            <table id="sources-table" class="table border-top">
                <thead>
                    <tr>
                        <th></th>
                        <th>Name</th>
