  ...
  <script type="module">
    $(function() {
      ...
      const addButton = canAdd ? {
        ...
        attr: {
          'onclick': canAdd ? "add('{{ route('settings.leads.activities.create') }}', 'modal-xl')" : "return false;",
        },
      ...
      var table = $('#activities-table').DataTable({
        ajax: "{{ route('settings.leads.activities') }}",
        columns: [{
            data: ''
          },
          {
        ...
        columnDefs: [{
          ...
          },
          {
            ...
            render: function(data, type, full, meta) {
              ...
              return '<label class="switch">' +
                '<input onclick="updateActiveStatus(&#39;/settings/leads/activities/status/' + full['id'] + '&#39;, &#39;activities-table&#39;)" type="checkbox" ' + $checkedStatus + ' class="switch-input">' +
          ...
          },
          {
            ...
            orderable: false,
            render: function(data, type, full, meta) {
              return '<span class="text-nowrap"><button class="btn btn-sm btn-icon me-2" onclick="edit()"><i class="ti ti-edit"></i></button>';
            },
            visible: canEdit
          }
        ],
