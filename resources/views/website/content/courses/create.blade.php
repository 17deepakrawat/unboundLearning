@php
  ...
  $content = !empty($courseContnet->content) ? json_decode($courseContnet->content, true) : [];
@endphp
@extends('layouts/layoutMaster')

@section('title', 'Content | Courses')
...
@section('content')
  ...
  <form id="contentForm" method="post" action="{{ route('website.content.courses') }}" enctype="multipart/form-data">
    <div class="row mb-3">
      <div class="col-md-12">
        <div class="card">
