...
<script type="module">
    ...
    <form action="{{route('website.content.career.update',[$vacancy->id])}}" method="POST" id="careerAddForm" enctype="multipart/form-data">
        @method('put')
                    ...
                    <div class="card-body">
                        <div class="row g-2">
                            <div class="col-md-12">
                                ...
                                value="{{$vacancy->name}}"    placeholder="ex: {{ config('variables.templateName') }}" autofocus required />
                            </div>

                            <div class="col-md-12">
                                <label class="form-label" for="type">City</label>
                                <input type="text" value="{{$vacancy->city}}" name="city" id="city" class="form-control" required>
                            </div>

                            <div class="col-md-12">
                                <label class="form-label" for="type">State</label>
                                <input type="text" value="{{$vacancy->state}}" name="state" id="state" class="form-control" required>
                            </div>

                            <div class="col-md-12">
                                <label class="form-label" for="type">Number Of Vacancy</label>
                                <input type="text" value="{{$vacancy->no_of_vacancy}}" name="no_of_vacancy" id="no_of_vacancy" class="form-control" required>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" value="{{$vacancy->shift_timing}}" name="shift_timing" id="shift_timing" class="form-control" required>
                            </div>

                            <div class="col-md-12">
                                <label class="form-label" for="type">Salary</label>
                                <input type="text" name="salary" value="{{$vacancy->salary}}" id="salary" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
