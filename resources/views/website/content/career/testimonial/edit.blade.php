...
<div class="modal-header">
    <h5 class="modal-title">Edit Team Talk</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<form action="{{ route('website.content.career.testimonial.update', [$testimonial->id]) }}" method="POST"
    id="testimonialAddForm" enctype="multipart/form-data">
    @method('put')
                ...
                <div class="row g-2">
                    <div class="col-md-12">
                        ...
                        <input type="text" id="name" name="name" class="form-control"
                            value="{{ $testimonial->name }}" placeholder="ex: {{ config('variables.templateName') }}"
                            autofocus required />
                    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-body border border-2">
                        <img src="{{ asset($testimonial->image) }}" alt="" id="image_preview" width="auto">
                    </div>
                </div>
            </div>
        </div>
