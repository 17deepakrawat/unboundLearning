...
@section('content')
    <section class="">
        <div class="about_bg">
            <div class="container blog_container about_section_padding">
                ...
                <p class="about_hero_content mb-md-5">Discover the inspiring story of SwayamVidya—empowering students with <br> education
                    and
                    opportunities, paving their way to success in top organizations.</p>
    ...
    <section class="my-5 py-md-3">
        <div class="container blog_container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="about_us_t2">We provide access to university-level courses and expert-led upskilling programs
                        designed to empower individuals to achieve academic and professional success. </p>
                    <p class="about_us_t2">With a focus on mentorship, innovation, and flexibility, Swayam Vidya supports
    ...
    {{-- <section class="my-5 py-md-3 photo_about_collab">
        <div class="container blog_container blog_collab_img ">
            <img src="{{ asset('assets/img/front-pages/icons/about_dot_shape.svg') }}" class="about_dot_shapel"
                alt="">
            <div class="about_grid align-items-center">
                <div class="items_about about_card_img1 ">
                    <img src="{{ asset('assets/img/front-pages/icons/about6.jpg') }}" alt=""
                        class="img-fluid w-100 h-100 about_img">
                </div>
                <div class="items_about about_card_img2">
                    <img src="{{ asset('assets/img/front-pages/icons/about1.jpg') }}" alt=""
                        class="img-fluid w-100 h-100 about_img">

                </div>
                <div class="items_about about_card_img3">
            ...
            <div class="about_grid1 align-items-start">
                <div class="items_about about_card_img4">
                    <img src="{{ asset('assets/img/front-pages/icons/about2.jpg') }}" alt=""
                        class="img-fluid w-100 h-100 about_img">


                </div>
                <div class="items_about about_card_img5">
                    <img src="{{ asset('assets/img/front-pages/icons/about4.jpg') }}" alt=""
                        class="img-fluid w-100 h-100 about_img">


                </div>
                <div class="items_about about_card_img6">
                    <img src="{{ asset('assets/img/front-pages/icons/about5.jpg') }}" alt=""
                        class="img-fluid w-100 h-100 about_img">
                </div>

            </div>
            <img src="{{ asset('assets/img/front-pages/icons/about_dot_shape.svg') }}" class="about_dot_shaper"
                alt="">
    ...
    <div class="image-gallery">
        <div class="col-two">
            <div class="col-row position-relative d-flex justify-content-end">
                <div class="img-landscape img-1 position-relative" style="background: url('assets/img/front-pages/icons/about6.jpg') no-repeat; background-size: cover; background-position: center;">
                </div>
                <img src="{{ asset('assets/img/front-pages/icons/about_dot_shape.svg') }}" class="a-dots d-none d-md-block"
                alt="">
            </div>
            <div class="col-row align-items-start" style="gap: 20px; margin-top: 20px;">
                <div class="img-6" style="background: url('assets/img/front-pages/icons/about2.jpg') no-repeat; background-size: cover;">
                </div>
                <div class="img-5" style="background: url('assets/img/front-pages/icons/about4.jpg') no-repeat; background-size: cover;">
                </div>
            </div>
        </div>
        <div class="col-two pt-lg-5">
            <div class="col-row align-items-end" style="gap: 20px;">
                <div class="img-2" style="background: url('assets/img/front-pages/icons/about1.jpg') no-repeat; background-size: cover;">
                </div>
                <div class="img-3" style="background: url('assets/img/front-pages/icons/about3.jpg') no-repeat; background-size: cover;">
                </div>
            </div>
            <div class="col-row position-relative">
                <div class="img-landscape position-relative" style="background: url('assets/img/front-pages/icons/about5.jpg') no-repeat; background-size: cover;">
                </div>
                <img src="{{ asset('assets/img/front-pages/icons/about_dot_shape.svg') }}" class="b-dots d-none d-md-block"
                alt="">
            </div>
        </div>
    </div>
...
<!-- about-us images container ends here -->
                ...
                <div class="col-lg-6 col-md-6  d-flex justify-content-center">
                    <div class="value-card-width">
                        ...
                        <div class="">
                            ...
                            <p class="value_card_sub_t">We believe in continuous innovation to provide the most up-to-date
                                and
                ...
                <div class="col-lg-6 col-md-6  d-flex justify-content-center">
                    <div class="value-card-width">
                        ...
                        <div class="">
                            ...
                            <p class="value_card_sub_t">Education should be available to everyone, regardless of location or
                    ...
                    <div class="value-card-width">
                        ...
                        <div class="">
                            ...
                            <p class="value_card_sub_t">At Swayam Vidya, we empower learners to take control of their
                                educational and professional development. Our courses are designed to build essential skills
                                and knowledge, giving individuals the confidence to excel in their careers and beyond.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="mt-5 py-md-3 know_container">
        <div class="container blog_container">
            <div class="row about_university">
                <div class="col-lg-5">
                    ...
                    <p class="about_knowledge_mest">At Swayam Vidya, we believe that strong partnerships are the foundation
                        for transformative growth and
                        success.
                        Our channel partners play a vital role in expanding our reach and enhancing the quality of education
                        we deliver.</p>
                    <div class="">
                        <a href="{{route('institutions-and-boards')}}">
                            <button class="about_knowledge_btn"><span class="about_knowledge_btn_t">Explore</span><img
                                src="{{ asset('assets/img/front-pages/icons/about_right_icon.svg') }}"
                                alt=""></button>
                        </a>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="university_card_about">
                        <div class="card card-body kn-icon1 kn-icon-al-1 p-0 m-0">
                            <img src="{{ asset('assets/img/front-pages/icons/know7.png') }}" class="kn-icon1"
                                alt="">
                        </div>
                        <div class="kn-icon2 kn-icon-al-2 p-0 m-0">
                            <img src="{{ asset('assets/img/front-pages/icons/know1.svg') }}" class="kn-icon2"
                                alt="">
                        </div>
                        <div class="card card-body kn-icon3 kn-icon-al-3 p-0 m-0">
                            <img src="{{ asset('assets/img/front-pages/icons/know6.png') }}" class="kn-icon3"
                                alt="">
                        </div>
                        <div class="card card-body kn-icon4 kn-icon-al-4 p-0 m-0">
                            <img src="{{ asset('assets/img/front-pages/icons/know5.png') }}" class="kn-icon4"
                                alt="">
                        </div>
                        <div class="card card-body kn-icon5 kn-icon-al-5 p-0 m-0">
                            <img src="{{ asset('assets/img/front-pages/icons/know2.jpg') }}" class="kn-icon5"
                                alt="">
                        </div>
                        ...
                        <div class=" kn-icon7 kn-icon-al-7 card card-body p-0 m-0">
                            <img src="{{ asset('assets/img/front-pages/icons/know4.png') }}" class="kn-icon7"
                                alt="">
                        </div>
    ...
    <section class="">
        ...
        <div class="work_partner_container pt-lg-5 pb-lg-5">
            <div class="container blog_container pt-lg-5">
                <p class="about_carousel_partner mb-lg-5"> Over the years, we have empowered numerous students to achieve their
                    ...
                    <div class="col-md-8 ">
                        <div class="about_carousel_img_row pt-md-2">
                            <div class="about_carousel_img_col  d-flex align-items-center justify-content-center  ">
                                <img src="{{ asset('assets/img/front-pages/icons/about_icon_5.png') }}" class="img-fluid" width="90" height="67"
                                    alt="">
                            </div>
                            <div class="about_carousel_img_col  d-flex align-items-center justify-content-center">
                                <img src="{{ asset('assets/img/front-pages/icons/about_icon_4.png') }}" class="img-fluid" width="116" height="47"
                                    alt="">
                            </div>
                            <div class="about_carousel_img_col  d-flex align-items-center justify-content-center">
                                <img src="{{ asset('assets/img/front-pages/icons/about_icon_3.png') }}" class="img-fluid" width="139" height="104"
                                    alt="">
                            </div>
                            <div class="about_carousel_img_col  d-flex align-items-center justify-content-center">
                                <img src="{{ asset('assets/img/front-pages/icons/about_icon_2.png') }}" class="img-fluid" width="120" height="43"
                                    alt="">
                            </div>
                            <div class="about_carousel_img_col  d-flex align-items-center justify-content-center">
                                <img src="{{ asset('assets/img/front-pages/icons/about_icon_1.png') }}" class="img-fluid" width="69" height="52"
                                    alt="">
                            </div>
                        </div>
                    </div>
