            ...
            <div class="row ">
                ...
                <div class="col-sm-12 ">
                    <div class="mob_filter_icon d-flex flex-row w-100 justify-content-start mb-3">
                        ...
                        <button class="bg-white d-block d-lg-none d-xl-none border-none shadow-none p-0 m-0 text-black filter_course_btn"
                                    ...
                                    <div class="swiper-slide swiper-slidees">
                                        <div class="card skill-cards  trending_courses_cardwh">
                                            ...
                                            <div class="card-body course_card_body">
                                                <span
                                                    class="badge upskill_textbg rounded-pill py-1 mb-2">{{ $program->programType->name }}</span>
                                                ...
                                                <span>
                                                    <img src="{{ asset('assets/img/front-pages/icons/component1.svg') }}"
                                                        alt="">
                                                </span>
