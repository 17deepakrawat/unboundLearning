...
@section('content')
    ...
    {{-- <div style="justify-content: center; display: flex;align-items:center;">
        <div class="enroll_form_know" style="">
            ...
            <form id="E-BookForm" method="POST">
                <div class="modal-body  m-3  justify-content-center">
                    <h5 class="modal-title view_popup_modal view_pop_text mb-3">Enter your WhatsApp Number
                        to get our exclusive E-Brochure</h5>
                    ...
                    <div class="p-0 m-0  view_verify_icon1 mb-0">
                    ...
                    <div class=" fv-plugins-icon-container">
                        <div
                            ...
                            <input type="tel"
                                class="form-control auth-input h-px-50 text-center numeral-mask mx-sm-1 my-2" maxlength="1"
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="d-flex flex-row view_check w-100 ">
                            <div class="view_bg">
                                <img src="{{ asset('assets/img/front-pages/icons/check 1.svg') }}" alt="">
                            </div>
                            <div class="">
                                <p class="view_check_t mb-0 mt-1">Please check your <i
                                        class="ti ti-brand-whatsapp text-success view_fs_6"></i> WhatsApp to view our
                                    exclusive E-Brochure.</p>
                            </div>
                        </div>
                    </div>
                    <div class="text-center">
    ...
    <div style="justify-content: center; display: flex;align-items:center;">
        <div class="enroll_form_know" style="">
            ...
            <form id="E-BookForm" method="POST">
                <div class="modal-body  m-3  justify-content-center">
                    <h5 class="modal-title view_popup_modal view_pop_text mb-3">Register to Start Your Learning Journey Now
                        !</h5>
                    ...
                    <div class="p-0 m-0  view_verify_icon2 mb-0">
                        <img src="{{ asset('assets/img/front-pages/icons/icon11.svg') }}" alt="">
                        <p class="view_verify_t mb-0">Verify</p>
                    </div>
                    <div class=" fv-plugins-icon-container">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="d-flex flex-row view_check w-100 h-50 ">
                            <div class="view_bg">
                                <img src="{{ asset('assets/img/front-pages/icons/check 1.svg') }}" alt="">
                            </div>
                            <div class="">
                                <p class="view_check_t mb-0 mt-1">We’ll reach out you between 10 am and 9 pm</p>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-center">
                        <div class="d-flex flex-row view_check w-100 h-50 ">
                            ...
                            <div class="">
                                <p class="view_check_t mb-0 mt-1">Unbiased career guidance</p>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-center">
                        <div class="d-flex flex-row view_check w-100 h-50 ">
                            ...
                            <div class="">
                                <p class="view_check_t mb-0 mt-1">Personalized guidance based on your skills and interests
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="text-center mt-2">
                        <button class="view_d_btn"> <span class="view_d_btn_t"> Enroll Now</span></button>
                    </div>
                </div>
            </form>
        </div>
