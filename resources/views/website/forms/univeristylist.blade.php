...
@section('vendor-script')
    @vite(['resources/assets/vendor/libs/nouislider/nouislider.js', 'resources/assets/vendor/libs/swiper/swiper.js', 'resources/assets/js/ui-carousel.js', 'resources/assets/vendor/libs/typeahead-js/typeahead.js'])
@endsection
        ...
        <div class="container university_container">
            <div class="row university_row">
                <div class="col-lg-9 col-xl-9 col-md-12 col-sm-12 ">
                    ...
                    <div class="">
                        <p class="university_title_text">{!! array_key_exists('university_text', $bannerContent) ? $bannerContent['university_text'] : '' !!}</p>
                    </div>
                                ...
                                <a href="/institutions-and-boards/{{ $vertical->slug }}">
                                    <div class="card shadow-none unveristy_list_card">
                                        <div class="university_img_card">
                                            <img src="{{ asset($vertical->logo) }}" alt=""
                                                class="university_img_card1">
                                        </div>
                                        <div class="card-body kp pb-0 university_card_body">
                                            ...
                                            <div class="mb-0 unveristy_list_card_paragraph">{!! !empty($content) ? Str::substr($content['section_1'], 0, 300) : '' !!}</div>
              ...
              {{-- <div class="pagination_custom d-flex justify-content-center">
                <ul class="d-flex flex-row mob-pagination" style="list-style: none;">
                  <li class="custom_num_pagination"><img src="{{ asset('assets/img/front-pages/icons/pagination_logo1.svg') }}" alt=""></li>
                  ...
                  <li class="custom_num_pagination"><img src="{{ asset('assets/img/front-pages/icons/pagination_logo.svg') }}" alt="">
                  </li>
                </ul>
              </div> --}}
            </div>
                ...
                <div class="col-lg-3 col-md-4 d-none d-lg-block d-xl-block">
                    <div class="mt-5">
                                ...
                                @if (!empty($bannerContent) && array_key_exists('ad_banner', $bannerContent))
                                    @foreach ($bannerContent['ad_banner'] as $banner)
                                        <div class="swiper-slide swiper-slides">
                                            <a url="{{ $banner['url'] }}" href="javascript:void(0)" class="course_swiper_a course_banner_redirection"
