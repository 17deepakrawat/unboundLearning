@php
  ...
  $blogBannerContent = !empty($blogAdBannerContent)&&!empty($blogAdBannerContent->content)?json_decode($blogAdBannerContent->content,true):[];
  $blogSuccessTalkContent = !empty($blogSuccessTalkContent)&&!empty($blogSuccessTalkContent->content)?json_decode($blogSuccessTalkContent->content,true):[];
@endphp
  ...
  if (stickyElement && parentContainer) {
    const updateStickyPosition = () => {
      ...
      if (scrollY > parentTop && scrollY + stickyHeight < parentBottom) {
        ...
        stickyElement.style.top = '5px'; // Adjust the top offset as needed
                    ...
                    success: function(response) {
                        ...
                        if (response.status === 200 && response.data.length > 0) {
                            ...
                            response.data.forEach(function(blog) {
                                // console.log(blog);
                                webHtml += '<button class="nav-link categories-tab d-flex justify-content-start dropdown-item p-2"  onclick=$("#query").val($(this).text());$(".blog-area-search").removeClass("show");$("#query").val($(this).text());$(".blog-area-search").removeClass("show");$(".blog-area-search").removeClass("d-block");$(".blog-area-search").addClass("d-none")>' + blog.name + '</button>';
                            });
    ...
    <div class="container blog_container">
      <div class="row">
        <div class="col-lg-8 col-md-12  blog_col">
                ...
                <div class="d-flex justify-content-between author_section_m">
                  <div class="d-flex flex-direction blog_author_s">
                    ...
                    <div class="">
                      ...
                      <p class="mb-0"><img src="{{ asset('assets/img/front-pages/icons/about_check.svg') }}" alt=""><span class="blog_author_subt">Verified writer</span></p>
                    </div>
                  </div>
                  <div class="">
              ...
              <div class="col-lg-12  ">
                <div class="blog_details_img_s">
                  <div class="blog_details_img">
                    <img src="{{ !empty($content) ? asset($content['image_section_1']) : '' }}" class="blog_details_img1" alt="">
                  </div>
                </div>
          ...
          <div class="blogdetails_content_s">
            ...
            <div class="swiper blog_details_img_sss  blog_details_img_s">
                ...
                @if (array_key_exists('images', $content))
                  @foreach ($content['images'] as $key => $value)
                    <div class="swiper-slide">
                      <div class="blog_details_img_s">
                        <div class="blog_details_img">
                          <img src="{{ asset($value) }}" class="blog_details_img1" alt="">
                        </div>
                      </div>
                    </div>
                  @endforeach
              ...
              <!-- Navigation buttons -->
              <div class="swiper-button-prevs swiper-button-prev"><img src="{{ asset('assets/img/front-pages/icons/arrowleft_blog_list.svg') }}" alt=""></div>
              <div class="swiper-button-nexts swiper-button-next"><img src="{{ asset('assets/img/front-pages/icons/arrowright_blog_list.svg') }}" alt=""></div>
            </div>
              ...
              <div class="w-100">
                <div class="blog_details_note_box align-items-center justify-content-center">
                  <div class="text-center">
                    <img src="{{ asset('assets/img/front-pages/icons/quote-left.svg') }}" alt="">
                  </div>
                ...
                <div class="blog_details_note_author">
                  <img src="{{ asset($content['images']?$content['images'][1]:'') }}" alt="" class="blog_details_note_author_img border-none">
                </div>
              </div>
            </div>
            <div class="blogdetails_content_s1">
                    ...
                    @foreach ($content['images'] as $key => $value)
                      @if ($loop->first)
                        <div class="grid_container1">
                          <img src="{{ asset($value) }}" class="grid_container_img1" alt="">
                        </div>
                      @endif
                    @endforeach
                  @endif
                        ...
                        @if ($loop->index >= 0 && $loop->index < 2)
                          <div class="col-lg-12">
                            <div class="grid_container2 grid_container_m">
                              <img src="{{ asset($value) }}" class="grid_container_img2" alt="">
          ...
          <div class="d-flex flex-row align-items-center bottom_share_s justify-content-center">
            ...
            <div class="blog_share_s_icon">
              <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}" target="_blank" class="btn btn-facebook"><i class="ti ti-brand-facebook-filled"></i></a>
            </div>
            <div class="blog_share_s_icon">
              <a href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}&text={{ urlencode($blogDetails->name) }}" target="_blank" class="btn btn-twitter"><i class="ti ti-brand-twitter"></i></a>
            </div>
            <div class="blog_share_s_icon">
              <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode(url()->current()) }}" target="_blank" class="btn btn-linkedin"><i class="ti ti-brand-linkedin"></i></a>
            </div>
            <div class="blog_share_s_icon"><a href="https://wa.me/?text={{ urlencode(url()->current()) }}" target="_blank" class="btn btn-whatsapp" style="color:white;background:#0080007a"><i class="ti ti-brand-whatsapp"></i></a></i></div>
          </div>
                ...
                <div class="col-lg-12 user_comment_m">
                  <div class="row">
                    <div class="col-lg-2 col-md-3 col_comment d-flex justify-content-center">
                      <div class="d-flex flex-row  comment_section_1">
                        <div class="comment_img_user">
                          <img src="{{ (asset($comment['user_avatar']&&!empty(json_decode($comment['user_avatar'],true)))?json_decode($comment['user_avatar'],true)[0]:"/assets/img/avatars/1.png") }}" class="comment_img_userurl" alt="">
                        </div>
                        <div class="comment_user_name">
                          <p class="comment_user_name_t mb-0">{{$comment['user_name']}}</p>
                          <p class="comment_user_name_t1 mb-0">{{\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $comment['created_at'], 'UTC')->setTimezone(env('APP_TIMEZONE_NAME','UTC'))->format('d M');}}</p>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-10 col-md-9 col_comment1">
        ...
        <div class="col-lg-1 blog_col1 blog_share_s_m  d-none d-lg-block d-xl-block">
          ...
          <div class="blog_share_s_icon"><a href="https://wa.me/?text={{ urlencode(url()->current()) }}" target="_blank" class="btn btn-whatsapp" style="color:white;background:#0080007a"><i class="ti ti-brand-whatsapp"></i></a></div>
        </div>
            ...
            <div class="col-lg-12">
              <div class="blog_search">
                <div class="search-containers blog_cont">
                  <input type="text" placeholder="Search our blogs" id="query" name="query" class="search-inputs nav-link dropdown-toggle" autocomplete="off" />
                  <button class="search-btns searchBlogs">
                    <img src="{{ asset('assets/img/front-pages/icons/icon23.svg') }}" alt="">
                  </button>
                </div>
                <div class="blog-area-search search-containers dropdown-menu mt-0 blog_search h-auto border-none d-none"></div>
              </div>
...
{{--                   
              ...
              <div class="d-flex justify-content-center d-none d-lg-block d-xl-block mt-4">
                <a href="{{ route('skill-programs') }}">
                  <div class="row p-0 m-0 blog_upskill_s1">
                    <div class=" mt-3 side_upskill_s blog_upskill_s w-100 d-flex align-items-center">
                      <div class="col-lg-5 h-100 pt-4">
                        <p class="skill_side_t">Upskill</p>
                      </div>
                      <div class="col-lg-7">
                        <img src="{{ asset('assets/img/front-pages/icons/side_skill.svg') }}" class="skill_img" alt="">
                      </div>
                    </div>
                  </div>
                </a>
                ...
                <div class="swiper" id="swiper-with-pagination">
                  <div class="swiper-wrapper">
                    @if (!empty($blogBannerContent) && array_key_exists('ad_banner',$blogBannerContent))
                      ...
                      <a href="{{$banner['url']}}">
                        <div class="swiper-slide" style="background-image: url('{{asset($banner["image"])}}');border-radius:12px;">
                        </div>
                      </a>
                      @endforeach
                      
                    @endif
                    {{-- <div class="swiper-slide" style="background-image: url('../../assets/img/front-pages/icons/blog_slide.jpg');border-radius:12px;">
                    </div> --}}
                  </div>
                  <!-- Pagination -->
                  ...
                  <div class="swiper-wrapper">
                    @if (!empty($blogSuccessTalkContent) && array_key_exists('success_talk',$blogSuccessTalkContent))
                      ...
                      <div class="swiper-slide d-flex align-items-center justify-content-center" style="background-color: #D9D9D9; border-radius:12px;">
                        <p><iframe width="560" height="315" src="{{$successTalk['url']}}" title="" frameBorder="0"   allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"  allowFullScreen></iframe></p>
                  ...
                  <form id="downloadEBrochureForm" action="{{ route('download-e-brochure-store') }}" method="POST">
                    <div class=" justify-content-center">
                      <div class="row g-3 mt-4">
                        <div class="col-md-12">
                          <input type="text" class="form-control blog_view_pop_field" id="fullName" name="fullName" placeholder="Full Name" aria-describedby="fullName">
                        </div>
                        <div class="col-md-12">
                          <input type="tel" class="form-control phone blog_view_pop_field" id="phone" name="phone" placeholder="ex: 98765XXXXX" aria-label="phone">
          ...
          <div class="col-lg-6 boxmail_col">
            ...
            <div class="row  story_title_mail ">
              <div class="col-lg-7 story_input_col">
                <div class="">
                  <input type="text" name="email" required class="form-control search-inputs w-100 story_input" placeholder="youremail@example.com">
                </div>
              </div>
          ...
          <div class="col-lg-6 boxmail_col boxmail_col1  d-flex justify-content-center ">
            <div class="blog-mailbox">
              <div class="card story_card">
                <img src="{{ asset('assets/img/front-pages/icons/footer_mail_img.jpg') }}" alt="" class="card-img-top story_card_img">
                <div class="card-body">
