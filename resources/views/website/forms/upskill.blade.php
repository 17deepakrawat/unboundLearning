...
@section('content')
    ...
    <section class=" upskill-bg" id="hero-animation" class="mb-4"
        ...
        <div class=" p-0 m-0 upskill-breadcrumb-bg" style=" background-color: #214dac00;">
        ...
        <div class="container skill_d_container px-5">
            <div class="d-flex flex-row mob-hero-banner">
                    ...
                    <div class="upskill-main mt-5">
                        <div class="wrapper_certified-programme d-flex align-items-center">
                            ...
                            <div class="wrapper_rating-star ms-2">
                                <img src="{{ asset('assets/img/front-pages/icons/star_filled.png') }}" class="img-fluid"
                                    alt="star">
                                <img src="{{ asset('assets/img/front-pages/icons/star_filled.png') }}" class="img-fluid"
                                    alt="star">
                                <img src="{{ asset('assets/img/front-pages/icons/star_filled.png') }}" class="img-fluid"
                        ...
                        <div class="wrapper_upskill-main-content mt-4">
                            ...
                            <h1 class="upskill-h1 mb-0">
                                {{ array_key_exists('meta', $content) ? $content['meta']['title'] : 'NA' }}
                                -</h1>
                                ...
                                @foreach ($verticals as $vertical)
                                    <div class="approv_uni_col">
                                        <div class="course_reco_s2">
                                            <img src="{{ asset($vertical['logo']) }}" class="img-fluid h-100"
                                                alt="">
                                        </div>
                ...
                <!-- <div class="skill_hero_main_img_s">
                    ...
                    <img src="{{ asset('assets/img/front-pages/icons/skill_hero_banner.png') }}" alt=""
                        class="skill_hero_banner">
                    <img src="{{ asset('assets/img/front-pages/icons/play_arrow_filled.png') }}" alt=""
                        class="play_arrow_filled">
                </div> -->
            </div>
        </div>
    ...
    <section class="my-5 py-md-3">
        <div class="container skill_d_container">
                    ...
                    @if (array_key_exists('tegSection', $content) && isset($content['tegSection']['tagimage']))
                        @foreach ($content['tegSection']['tagtitle'] as $key => $tags)
                            <div class="wrapper_description-card">
                                <img src="{{ asset($content['tegSection']['tagimage'][$key]) }}" width="50"
                                    height="50" class="description-card-img img-fluid" alt="details icon">
                                <p class="description-card-name mb-0">{{ $content['tegSection']['tagtitle'][$key] }}</p>
                            </div>
                        @endforeach
                    @endif
                    {{-- <div class="wrapper_description-card">
            <img src="{{ asset('assets/img/front-pages/icons/upskill-icon1.png') }}" width="50" height="50"
                class="description-card-img img-fluid" alt="details icon">
                <p class="description-card-name mb-0">Course Duration :
                    {{ $specialization->min_duration.' '.$specialization->mode->name }}</p>
            </div>
            <div class="wrapper_description-card">
                <img src="{{ asset('assets/img/front-pages/icons/upskill-icon2.png') }}" width="50" height="50"
                    class="description-card-img img-fluid" alt="details icon">
                <p class="description-card-name mb-0">Training by Industrial experts</p>
            </div>
            <div class="wrapper_description-card">
                <img src="{{ asset('assets/img/front-pages/icons/upskill-icon3.png') }}" width="50" height="50"
                    class="description-card-img img-fluid" alt="details icon">
                <p class="description-card-name mb-0">24 *7 LMS Access</p>
            </div>
            <div class="wrapper_description-card">
                <img src="{{ asset('assets/img/front-pages/icons/upskill-icon4.png') }}" width="50" height="50"
                    class="description-card-img img-fluid" alt="details icon">
                <p class="description-card-name mb-0">Flexible timings</p>
            </div>
            <div class="wrapper_description-card">
                <img src="{{ asset('assets/img/front-pages/icons/upskill-icon5.png') }}" width="50" height="50"
                    class="description-card-img img-fluid" alt="details icon">
            ...
            <div class="wrapper_description-card position-relative" style="background-color: #E4EBF3;">
                <img src="{{ asset('assets/img/front-pages/icons/upskill-icon6.png') }}" width="50" height="50"
                    class="description-card-img img-fluid" alt="details icon">
                <p class="description-card-name mb-0">20+ Real-Time Projects</p>
                <img src="{{ asset('assets/img/front-pages/icons/upskill-icon12.png') }}" width="30" height="30"
                    class="description-card-img img-fluid position-absolute diamond-icon" alt="details icon">
            </div>
            <div class="wrapper_description-card">
                <img src="{{ asset('assets/img/front-pages/icons/upskill-icon7.png') }}" width="50" height="50"
                    class="description-card-img img-fluid" alt="details icon">
                <p class="description-card-name mb-0">Live Classes</p>
            </div>
            <div class="wrapper_description-card">
                <img src="{{ asset('assets/img/front-pages/icons/upskill-icon8.png') }}" width="50" height="50"
                    class="description-card-img img-fluid" alt="details icon">
                <p class="description-card-name mb-0">Soft Skill Sessions</p>
            </div>
            <div class="wrapper_description-card position-relative" style="background-color: #E4EBF3;">
                <img src="{{ asset('assets/img/front-pages/icons/upskill-icon9.png') }}" width="50" height="50"
                    class="description-card-img img-fluid" alt="details icon">
            ...
            <div class="wrapper_description-card">
                <img src="{{ asset('assets/img/front-pages/icons/upskill-icon10.png') }}" width="50" height="50"
                    class="description-card-img img-fluid" alt="details icon">
                <p class="description-card-name mb-0">Placement Assistance </p>
            </div>
            <div class="wrapper_description-card">
                <img src="{{ asset('assets/img/front-pages/icons/upskill-icon11.png') }}" width="50" height="50"
                    class="description-card-img img-fluid" alt="details icon">
    ...
    <section class="my-5 py-md-2">
            ...
            <div class="wrapper_skill-covered">
                <div class="wrapper_custom-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="header-right">
                        <a href="#" class="get-free-demo-btn text-light">Get <span style="color: #FF8818;">FREE</span>
                            Demo
                            <img src="{{ asset('assets/img/front-pages/icons/f-arrow-right.svg') }}" class="img-fluid"
                                alt="arrow-right"> </a>
                    </div>
                </div>
                ...
                <div class="row mt-4">
                        ...
                        @foreach ($content['skillSection']['skilltitle'] as $key => $value)
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                                <div class="wrapper_skill-covered-card p-4 mb-4">
                                    <img src="{{ asset($content['skillSection']['skillimage'][$key]) }}"
                                        class="img-fluid mb-2" alt="skill covered">
                                    <h4 class="skill-covered-title mb-2">{{ $content['skillSection']['skilltitle'][$key] }}
                                    </h4>
                    ...
                    {{-- <div class="col-12 col-md-6 col-lg-4 col-xl-3">
            <div class="wrapper_skill-covered-card p-4 mb-4">
              <img src="{{ asset('assets/img/front-pages/icons/skill-c1.png') }}" class="img-fluid mb-2" alt="skill
                covered">
        ...
        <div class="col-12 col-md-6 col-lg-4 col-xl-3">
            <div class="wrapper_skill-covered-card p-4 mb-4">
                <img src="{{ asset('assets/img/front-pages/icons/skill-c2.png') }}" class="img-fluid mb-2"
                    alt="skill covered">
        ...
        <div class="container skill_d_container">
            <div class="wrapper_what-you-learn">
                <div class="wrapper_custom-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="header-right">
                        <p><a href="#" class="get-free-demo-btn text-light">Know More <img
                                    src="{{ asset('assets/img/front-pages/icons/f-arrow-right.svg') }}" class="img-fluid"
                                    alt="arrow-right"> </a></p>
                    </div>
                </div>
                ...
                <div class="what-you-learn-desc mt-4">
                    <div class="row">
                            ...
                            @foreach ($content['learnSection']['learntitle'] as $key => $value)
                                <div class="col-6 col-md-6 col-lg-4 col-xl-3">
                                    <div class="learn-desc mb-2">
                                        <img src="{{ asset('assets/img/front-pages/icons/icon-check4.png') }}"
                        ...
                        {{-- <div class="col-6 col-md-6 col-lg-4 col-xl-3">
              <div class="learn-desc mb-2">
                <img src="{{ asset('assets/img/front-pages/icons/icon-check4.png') }}" class="img-fluid" alt="check
                    icon">
            ...
            <div class="col-6 col-md-6 col-lg-4 col-xl-3">
                <div class="learn-desc mb-2">
                    <img src="{{ asset('assets/img/front-pages/icons/icon-check4.png') }}" class="img-fluid"
                        alt="check icon">
            ...
            <div id="carousel-container">
                ...
                @if (array_key_exists('studentsection', $content) && count($content['studentSection']['studenttitle']) > 0)
                    @foreach ($content['studentsection']['studenttitle'] as $key => $value)
                        <div class="card card1 custom_blur_student border-none shadow-none "
                            style="    background: #ffffff24 !important;">
                            <div class="student_custom_section">
                                <div class="student_custom_card_c">
                                    <div class="student_custom_card_c1 student_custom1"></div>
                                    <div class="student_custom_mt"> <span class="student_custom_t">Meet <span
                                                class="student_custom_b">Gopika P,</span>Placed as</span><br><span
                                            class="student_custom_t">Data Scientist at </span><span
                                            class="student_custom_b">infosys</span></div>
                                </div>
                                <div class="student_custom_card_c">
                                    <div class="student_custom_card_c1 student_custom2"></div>
                                    <div class="student_custom_mt1"> <span class="student_custom_t">Meet <span
                                                class="student_custom_b">Gopika P,</span>Placed as</span><br><span
                                            class="student_custom_t">Data Scientist at </span><span
                                            class="student_custom_b">infosys</span></div>
                                ...
                                <div class="student_custom_card_c">
                                    ...
                                    <div class="student_custom_mt2"> <span class="student_custom_t">Meet <span
                                                class="student_custom_b">Gopika P,</span>Placed as</span><br><span
                                            class="student_custom_t">Data Scientist at </span><span
                                            class="student_custom_b">infosys</span></div>
                                ...
                                <div class="student_custom_card_c">
                                    ...
                                    <div class="student_custom_mt3"> <span class="student_custom_t">Meet <span
                                                class="student_custom_b">Gopika P,</span>Placed as</span><br><span
                                            class="student_custom_t">Data Scientist at </span><span
                                            class="student_custom_b">infosys</span></div>
                                ...
                                <div class="student_custom_card_c">
                                    ...
                                    <div class="student_custom_mt4"> <span class="student_custom_t">Meet <span
                                                class="student_custom_b">Gopika P,</span>Placed as</span><br><span
                                            class="student_custom_t">Data Scientist at </span><span
                                            class="student_custom_b">infosys</span></div>
        ...
        <div class="card card1">
          ...
          <div class="student_custom_sections1 ">
            ...
            <div class="button-container d-flex justify-content-center student_blur align-items-center  ">
                <button id="show-more" class="student_show_btn border-none shadow-none"> <span
                        class="student_show_btn_t">Show More</span></button>
                <button id="unlock-success" class="student_unlock_btn border-none shadow-none"><span
                        class="student_unlock_btn_t">Unlock Your Success</span></button>
            </div>
        </div>
        ...
        <div class="container skill_d_container">
            <div class="wrapper_tools-covered">
                <div class="wrapper_custom-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="header-right">
                        <p><a href="#" class="get-free-demo-btn text-light">Enroll Now <img
                                    src="{{ asset('assets/img/front-pages/icons/f-arrow-right.svg') }}" class="img-fluid"
                                    alt="arrow-right"> </a></p>
                    </div>
                </div>
                            ...
                            @foreach ($content['toolcover'] as $key => $value)
                                <div class="col-6 col-md-3 col-lg-3 col-xl-3">
                                    <div class="tools-covered-card mb-2">
                                        <img src="{{ asset($value) }}" class="img-fluid" alt="icon"
                ...
                <div class="row align-items-center">
                            ...
                            <div class="row mt-5">
                                            ...
                                            @foreach ($content['jobroleSection']['jobroletitle'] as $key => $value)
                                                <div class="col-12 col-md-6 col-lg-4 data_col_learn">
                                                    <div class="learn-desc mb-3">
                                                        <img src="{{ asset('assets/img/front-pages/icons/g-cap.png') }}"
                                                            class="img-fluid" alt="check icon">
                                                        <p class="upskill-title-detail mb-0 text-white">
                                                            {{ $value }}</p>
                                                    </div>
                                                </div>
                                            @endforeach
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="curriculum-btn ">
                                        <a href="#" class="s-block data_btn_mob curr-btn text-light">Know More <img
                                                src="{{ asset('assets/img/front-pages/icons/f-arrow-right.svg') }}"
                                                width="15" height="15" class="img-fluid" alt="arrow-right"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-6 col-md-3 col-lg-2 mob_img_data">
                        <div class="wrapper_curriculum-img mt-3 text-center">
                            <img src="{{ asset('assets/img/front-pages/icons/curriculum-icon.png') }}" class="img-fluid"
                    ...
                    @foreach ($content['jobroleSection']['jobroletitle'] as $key => $value)
                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 course_blog_col">
                            <div class="job-roles mb-4">
                                <img src="{{ asset($content['jobroleSection']['jobroleimage'][$key]) }}"
                                    class="img-fluid w-100" alt="skill covered">

                                <div class="roles text-center p-4">
                                    <h4 class="role-title mb-2">{{ $content['jobroleSection']['jobroletitle'][$key] }}
                                    </h4>
                                    <p class="role-desc">
                                        {{ $content['jobroleSection']['jobroledescription'][$key] }}
                                    </p>
                                    <a href="#" class="s-block mx-auto job-roles-btn">Know More <img
                                            src="{{ asset('assets/img/front-pages/icons/arrow-right.svg') }}"
                                            width="15" height="15" class="img-fluid" alt="arrow-right"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <!-- <div class="col-12 col-md-6 col-xl-4">
                            <div class="who-can-apply-short-content mb-3 ms-5 ms-md-1">
                                <p class="mb-0">
                                    <img src="{{ asset('assets/img/front-pages/icons/green-check-icon.png') }}"
                                        class="img-fluid" alt="arrow-right">
                        ...
                        <div class="col-12 col-md-12 col-xl-6">
                            <div class="who-can-apply-long-content mb-3 p-3 p-xl-5">
                                ...
                                <p><a href="#" class="get-free-demo-btn w-100 mt-4"
                                        style="background-color: #0F9D58;">
                                        Know
                                        More <img src="{{ asset('assets/img/front-pages/icons/f-arrow-right.svg') }}"
                                            class="img-fluid" alt="arrow-right"> </a></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center mt-md-0 mt-lg-4 mt-4">
                        ...
                        <div class="courses-recognised-by">
                            ...
                            <div class="sample-certificate">
                                <div class="wrapper_certificate-card">
                                    <img src="{{ asset('assets/img/front-pages/icons/ec3.png') }}"
                                        class="img-fluid recognised-by-img" alt="Recognised By">
                                </div>
                                <div class="wrapper_certificate-card">
                                    <img src="{{ asset('assets/img/front-pages/icons/ec4.png') }}"
                                        class="img-fluid recognised-by-img" alt="Recognised By">
                                </div>
                                <div class="wrapper_certificate-card">
                                    <img src="{{ asset('assets/img/front-pages/icons/ec4.png') }}"
                            ...
                            <div class="sample-certificate">
                                <div class="wrapper_certificate-card">
                                    <div class="certificate-card mb-2">
                                        <img src="{{ asset('assets/img/front-pages/icons/ec5.png') }}"
                                            class="img-fluid eye-icon" alt="icon">
                                    </div>
                                    <p class="view-certificate-text text-center"><img
                                            src="{{ asset('assets/img/front-pages/icons/ec6.png') }}" class="img-fluid"
                                            alt="icon"> View sample certificate</p>
                                </div>
                                <div class="wrapper_certificate-card">
                                    <div class="certificate-card mb-2">
                                        <img src="{{ asset('assets/img/front-pages/icons/ec5.png') }}"
                    ...
                    <div class="col-12 col-md-12 col-lg-3">
                        <div class="wrapper_support">
                            <img src="{{ asset('assets/img/front-pages/icons/ec1.png') }}"
                                class="img-fluid d-block mx-auto mt-4 mb-5 wrapper_support_img" alt="icon">

                            <div class="wrapper_support-no">
                                <img src="{{ asset('assets/img/front-pages/icons/ec2.png') }}" class="img-fluid"
                                    alt="icon">
                                <div>
                                    <p class="mb-0 support-title"><a href="#" class="text-dark"> Having <span
                                                class="fw-support-no">Trouble?</span> </a></p>
                                    <p class="mb-0 support-title"><a href="#" class="text-dark"> Connect <span
                                                class="fw-support-no">Support Team</span> </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="my-5 py-md-4">
        <div class="container skill_d_container">
            <div class="row justify-content-center  ">
                ...
                <div class="col-lg-3 col-md-12 col-skil-faq d-flex justify-content-end"><button
                        class="skill_faq_btn"><span><img
                                src="{{ asset('assets/img/front-pages/icons/skill_faq_icon.svg') }}"
                                alt=""></span><span class="skill_faq_btn_t">Ask Your Questions</span></button>
                </div>
                <div class="col-lg-12 col-md-12 skil_course_faq">
                    <div class="accordion" id="faqAccordion">
                        ...
                        <div class="card skill_faq shadow-none accordion-item">
                            ...
                            <div id="faq5" class="accordion-collapse collapse faq_question"
