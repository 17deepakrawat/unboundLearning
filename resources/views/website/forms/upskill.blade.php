            ...
            <div class="">
                <div class="upskill-main mt-5">
                    ...
                    <div class="wrapper_upskill-main-content mt-4">
                        ...
                        <h1 class="upskill-h1 mb-0">{{array_key_exists('meta',$content)?$content['meta']['title']:"NA"}}
                            -</h1>
        ...
        <div class="wrapper_upskill-container ">
            ...
            <div class="wrapper_short-descriptions">
                ...
                <div class="wrapper_description-card">
                    <img src="{{ asset($content['tegSection']['tagimage'][$key]) }}" width="50" height="50"
        ...
        <div class="wrapper_skill-covered">
            <div class="wrapper_custom-header d-flex justify-content-between align-items-center">
                ...
                <div class="header-right">
                    <a href="#" class="get-free-demo-btn text-light">Get <span style="color: #FF8818;">FREE</span> Demo
            ...
            <div class="row mt-4">
                ...
                <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="wrapper_skill-covered-card p-4 mb-4">
                        <img src="{{ asset($content['skillSection']['skillimage'][$key]) }}" class="img-fluid mb-2"
                            alt="skill covered">
        ...
        <div class="row mt-4 course_blog_row">
            ...
            <div class="col-12 col-md-6 col-lg-4 col-xl-3 course_blog_col">
                <div class="job-roles mb-4">
                    <img src="{{ asset($content['jobroleSection']['jobroleimage'][$key]) }}" class="img-fluid w-100"
                        alt="skill covered">
                    ...
                    <div class="roles text-center p-4">
                        ...
                        <a href="#" class="s-block mx-auto job-roles-btn">Know More <img
                                src="{{ asset('assets/img/front-pages/icons/arrow-right.svg') }}" width="15" height="15"
                                class="img-fluid" alt="arrow-right"></a>
                    </div>
                </div>
            </div>
            @endforeach
                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-12 col-md-12 col-xl-6">
                        <div class="who-can-apply-long-content mb-3 p-3 p-xl-5">
                            ...
                            <p><a href="#" class="get-free-demo-btn w-100 mt-4" style="background-color: #0F9D58;">
                                    Know
        ...
        <div class="row justify-content-center  ">
            ...
            <div class="col-lg-3 col-md-12 col-skil-faq d-flex justify-content-end"><button
                    class="skill_faq_btn"><span><img
                            src="{{ asset('assets/img/front-pages/icons/skill_faq_icon.svg') }}" alt=""></span><span
                        class="skill_faq_btn_t">Ask Your Questions</span></button>
            </div>
