...
@endsection
@section('content')
    <form action="{{ route('website.content.blogs') }}" method="POST" id="blogAddForm" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row g-2">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" id="meta_description" name="content[meta][description]"
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="meta_keywords" class="form-control" name="content[meta][keywords]" />
                            </div>

                            <div class="col-md-12">
                                <label class="form-label" for="other_meta_tags">Other Tags</label>
                                <textarea class="form-control" id="other_meta_tags" name="content[meta][otherTags]" rows="5"></textarea>
                            </div>

                            <div class="col-md-12">
                                <label class="form-label" for="popular_tags">Popular tags</label>
                                <input id="popular_tags" class="form-control" name="content[populartag]" />
                            </div>

                            <div class="col-md-12">
                                <label class="form-label" for="quote">Quote</label>
                                <input id="quote" class="form-control" name="content[quote]" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <span class="text-center text-muted">Preview</span>
                            <div class="card card-body border border-2">
                                <img src="" alt="" class="ratio ratio-4x3" id="banner_image_1_preview"
                                    width="auto">
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <span class="text-center text-muted">Preview</span>
                            <div class="card card-body border border-2">
                                <img src="" alt="" class="ratio ratio-4x3" id="image_section_1_preview"
                                    width="auto">
                            </div>
                        </div>
