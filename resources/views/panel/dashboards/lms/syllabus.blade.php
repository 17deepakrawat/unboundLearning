        ...
        <div class="card mb-6">
          <div class="card-header d-flex flex-wrap justify-content-between gap-4">
              <div class="card-title mb-0 me-1">
                  <h5 class="mb-0">My Syllabus</h5>
              </div>
              <div class="d-flex justify-content-md-end align-items-center column-gap-6">
                  {{-- <label for="vertical_id" class="m-2">Vertical</label>
          ...
          <div class="card-body">
              <div class="row gy-6 mb-6">
                  @foreach ($syllabus as $singleSyllabus)
                      <div class="col-sm-6 col-lg-4">
                          <div class="card p-2 shadow-none border">
                              <div class="rounded-2 text-center mb-4 bg-label-success"
                                  style="height: 186px;display: flex;justify-content: center;align-items: center;flex-direction: column;line-height: 3px;">
                                  <p>{{ $singleSyllabus->name }}</p><br>
                                  <p>({{ $singleSyllabus->code }})</p>
                              </div>
                              <div class="card-body p-1 pt-2">
                                  <a href="#" class="h5">{{ $singleSyllabus->name }}</a>
                                  <br>
                                  <div
                                      class="d-flex flex-column flex-md-row gap-2 text-nowrap flex-wrap flex-md-nowrap  flex-lg-wrap flex-xxl-nowrap">
                                      <a class="w-100 btn btn-label-primary d-flex align-items-center"
                                          href="{{ route('student.lms.videos', [$singleSyllabus->id]) }}">
                                          <i class="ti ti-movie"></i><span>Videos</span>
                                      </a>
                                      <a class="w-100 btn btn-label-primary d-flex align-items-center"
                                          href="{{ route('student.lms.notes', [$singleSyllabus->id]) }}">
                                          <i class="ti ti-notes"></i><span>Notes
                                              ({{ count($singleSyllabus->notes) }})
                                          </span>
                                      </a>
                                      <a class="w-100 btn btn-label-primary d-flex align-items-center"
                                          href="{{ route('student.lms.ebooks', [$singleSyllabus->id]) }}">
                                          <i class="ti ti-book"></i><span>E-Books
                                              ({{ count($singleSyllabus->ebooks) }})</span>
                                      </a>
                                  </div>
                              </div>
                          </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                      <div class="card p-2 h-100 shadow-none border">
                        ...
                        <div class="card-body p-4 pt-2">
                          ...
                          <a class="w-100 btn btn-label-primary" href="app-academy-course-details.html"><i class="ti ti-rotate-clockwise-2 ti-xs me-1_5"></i>Start Over</a>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
              ...
              <div class="card-body row gy-6">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                  <div class="card h-100 border shadow-none">
                    <div class="p-2 pb-0">
                      <video poster="../../../../cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-HD.jpg" id="guitar-video-player" playsinline controls>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                  <div class="card h-100 border shadow-none">
                    <div class="p-2 pb-0">
                      <video poster="../../../../cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-HD.jpg" id="guitar-video-player-2" playsinline controls>
                        <source src="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-576p.mp4" type="video/mp4" />
                      </video>
                    </div>
                    <div class="card-body">
