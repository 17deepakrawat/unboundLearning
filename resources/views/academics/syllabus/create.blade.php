...
<form id="syllabusForm" action="{{ route('academics.syllabus') }}" method="POST">
  <div class="modal-body">
    <div class="row g-3">
      ...
      <div class="col-md-6">
        ...
        <input type="number" min="0" class="form-control" name="minimum_marks" id="minimum_marks" >
      </div>
      <div class="col-md-6">
        <label for="maximum_marks" class="form-label">Maximum Marks</label>
        <input type="number" min="0" class="form-control" name="maximum_marks" id="maximum_marks">
      </div>
    </div>
  </div>
...
<script>
  $(function() {
    ...
    $("#syllabusForm").submit(function(e) {
      e.preventDefault();
      if ($("#syllabusForm").valid() && marksValidate()) {
  ...
  {
    var minimumMarks = $('#minimum_marks').val();
    var maximumMarks = $('#maximum_marks').val();
    if(minimumMarks!='' && maximumMarks!='')
    {
      if(parseInt(minimumMarks)>parseInt(maximumMarks))
      {
        var msg = '<label id="maximum_marks-error" class="error" for="maximum_marks" style="">Maximum marks should be greater than minimum marks.</label>';
        $('#maximum_marks').after(msg);
        return false;
      }
      return true;
    }
