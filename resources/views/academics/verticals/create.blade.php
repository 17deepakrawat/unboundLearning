...
<form id="addVerticalForm" method="POST" enctype="multipart/form-data" action="{{ route('academics.verticals') }}">
  <div class="modal-body">
    <div class="row g-3">
      <div class="col-md-12">
        <label class="form-label" for="name">Name</label>
        <input type="text" id="name" name="name" class="form-control" placeholder="ex: {{ !empty(config('variables.templateName')) ? config('variables.templateName') : '' }}" />
      </div>

      <div class="col-md-6">
        <label class="form-label" for="short_name">Short Name</label>
        <input type="text" id="short_name" name="short_name" class="form-control" placeholder="ex: {{ !empty(config('variables.templateShortName')) ? config('variables.templateShortName') : '' }}" />
      </div>

      <div class="col-md-6">
        <label class="form-label" for="vertical_name">Vertical</label>
        <input type="text" id="vertical_name" name="vertical_name" class="form-control" placeholder="ex: {{ !empty(config('variables.templateVerticalName')) ? config('variables.templateVerticalName') : '' }}" />
      </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-body border border-2">
              <img src="" alt="" class="ratio ratio-21x9" id="logoPreview" width="auto" height="100px">
            </div>
          </div>
        </div>
      </div>
