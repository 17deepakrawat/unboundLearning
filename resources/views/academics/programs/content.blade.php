...
@section('content')
  ...
  @endphp
  <form id="contentForm" method="post" action="{{ route('academics.programs.content.store') }}">
    <div class="row mb-3">
      <div class="col-md-12">
          ...
          <div class="card-body">
            <div class="row g-2">
              <div class="col-md-12">
                ...
                <input type="text" id="meta_title" name="content[meta][title]" value="{{ array_key_exists('meta', $content) && array_key_exists('title', $content['meta']) ? $content['meta']['title'] : $program->name }}" class="form-control" placeholder="ex: {{ config('variables.templateName') }}" autofocus required />
              </div>
